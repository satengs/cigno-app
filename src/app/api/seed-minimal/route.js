...
export async function POST() {
  try {
    await connectDB();
    console.log('Database connected, starting minimal seed operation...');
    ...
    console.log('🎉 Minimal seed operation completed successfully!');
    ...
    return NextResponse.json({
      success: true,
      message: 'Minimal seed data created successfully',
      data: {
        organisation: savedOrganisation._id,
    ...
    console.error('Error in minimal seed operation:', error);
    return NextResponse.json({ 
